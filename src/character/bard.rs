...
pub const BARD_DATA: CharacterData = CharacterData {
    ...
    default_name: "Marcus",
    audio: [
        ("characters/bard-0.mp3", "Let the music guide us."),
        ("characters/bard-1.mp3", "Together we are unstoppable."),
        ("characters/bard-2.mp3", "I'll amplify your strength."),
        (
            "characters/bard-greet.mp3",
            "Ah, a new face! Let me play you the song of our people.",
        ),
    ],
    icon: (
        "characters/bard_icon.png",
        "characters/bard_icon_selected.png",
    ),
