...
> **Note on Architecture**: This tutorial demonstrates a simplified enum-based approach for educational clarity. The
> production codebase uses a more scalable trait-based architecture with separate component types (see the *
*Implementation Details** section for the production approach). While the enum pattern shown here works well for
> learning and small projects, production games benefit from the modularity and team scalability of the trait-based
> design.
